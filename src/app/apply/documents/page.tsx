...
export default function DocumentsPage() {
  ...
  const [uploadedFiles, setUploadedFiles] = useState(() => {
    const savedFiles = getFromSessionStorage("uploadedDocuments");
    return savedFiles || {};
  });
  ...
  const getDocumentRequirements = (): DocumentRequirement[] => {
    const baseRequirements: DocumentRequirement[] = [
      {
        ...
        description:
          "Clear copy of your national identification card (both sides)",
        required: true,
      ...
      },
      {
        ...
        description:
          "Medical fitness certificate from authorized healthcare provider (not older than 6 months)",
        required: true,
        acceptedFormats: ["PDF", "JPG", "PNG"],
        maxSize: 5,
      },
    ...
    if (applicationData.licenseType === "commercial") {
      baseRequirements.push({
        ...
        description:
          "Official driving record certificate showing no major violations",
        required: true,
        acceptedFormats: ["PDF", "JPG", "PNG"],
        maxSize: 5,
      });
  ...
  const validateFile = (
    ...
    if (
      !fileExtension ||
      !requirement.acceptedFormats.includes(fileExtension)
    ) {
  ...
  const handleFileUpload = async (
    ...
    setTimeout(() => {
      ...
      saveToSessionStorage("uploadedDocuments", newFiles);
  ...
  const handleNext = async () => {
    if (!validateAllDocuments()) return;
    ...
    try {
      ...
      saveToSessionStorage("uploadedDocuments", uploadedFiles);
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600 font-inter">
              Please upload clear, legible copies of all required documents. All
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-500">
                          {requirement.acceptedFormats.join(", ")} up to{" "}
                          {requirement.maxSize}MB
                        </span>
                      </label>
                    </div>
                  )}{" "}
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 space-y-1">
                  ...
                  <li>
                    • Medical certificate must be issued within the last 6
                    months
                  </li>
          ...
          <div className="flex justify-between pt-6 border-t border-gray-200 mt-8">
            ...
            >
              <span>{isSubmitting ? "Saving..." : "Continue to Photo"}</span>
              {!isSubmitting && (
